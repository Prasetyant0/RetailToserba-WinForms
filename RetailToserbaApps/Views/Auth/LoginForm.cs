                ...
                case "Admin":
                    {
                        ...
                        mainForm.FormClosed += DashboardForm_FormClosed;
                        mainForm.Show();
                        break;
                    }
                case "Kasir":
                    {
                        ...
                        cashierForm.SetCurrentUser(user); // ✅ Direct call
                        cashierForm.FormClosed += DashboardForm_FormClosed;
                        cashierForm.Show();
                        break;
                    }
                case "Gudang":
                    {
                        ...
                        // warehouseForm.SetCurrentUser(user);
                        warehouseForm.FormClosed += DashboardForm_FormClosed;
                        warehouseForm.Show();
                        break;
                    }
                default:
...
namespace RetailToserbaApps.Views.Auth
{
    public partial class LoginForm : MaterialForm
    {
        ...
        private void OpenDashboard(User user)
        {
            ...
            // If dashboard supports setting current user, pass user info
            if (dashboardForm is RetailToserbaApps.Views.Dashboard.CashierForm cashierForm)
            {
                cashierForm.SetCurrentUser(user);
            }
            else if (dashboardForm is RetailToserbaApps.Views.Dashboard.MainForm mainForm)
            {
                // Optionally set user details on main form if needed in future
            }
            else if (dashboardForm is RetailToserbaApps.Views.Dashboard.WarehouseForm warehouseForm)
            {
                // Optionally set user details on warehouse form
            }
